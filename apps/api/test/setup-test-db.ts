...
export async function resetTestDb(): Promise<void> {
  ...
  await client`TRUNCATE users, refresh_tokens, customers, projects, user_tenants, project_members, issues, issue_comments, blueprints, blueprint_versions, project_stages, project_risks, meeting_minutes, minute_attachments, audit_logs`;
  await client.end();
}
